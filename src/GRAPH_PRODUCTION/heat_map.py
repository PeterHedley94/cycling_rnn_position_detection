...
def generate_heat_map(title,x_data,y_data,z_data,x_axis_title,y_axis_title,z_axis_title,graph_name):
    ...
    contour = ax.tricontourf(df[x_axis_title], df[y_axis_title], df[z_axis_title],levels=levels)
